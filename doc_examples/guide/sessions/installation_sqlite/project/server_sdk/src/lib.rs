...
impl ApplicationState {
    ...
    async fn _new(
        ...
        let v3 = pavex_session_sqlx::SqliteSessionStore::new(v0);
...
impl Router {
    ...
    fn router() -> matchit::Router<u32> {
        ...
        router.insert("/ops/client", 1u32).unwrap();
...
pub mod route_1 {
    ...
    async fn handler(v0: &mut pavex_session::Session<'_>) -> pavex::response::Response {
        let v1 = session_installation_sqlite::ops::clear::handler(v0).await;
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
                    let v3 = pavex::Error::new(v2);
                    let v4 = session_installation_sqlite::ops::e500(&v3);
                    <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                        v4,
                    )
                };
...
pub mod route_2 {
    ...
    async fn handler(v0: &mut pavex_session::Session<'_>) -> pavex::response::Response {
        let v1 = session_installation_sqlite::ops::client::handler(v0).await;
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
...
pub mod route_3 {
    ...
    async fn handler(v0: &mut pavex_session::Session<'_>) -> pavex::response::Response {
        let v1 = session_installation_sqlite::ops::cycle_id::handler(v0).await;
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
...
pub mod route_4 {
    ...
    async fn handler(v0: &mut pavex_session::Session<'_>) -> pavex::response::Response {
        let v1 = session_installation_sqlite::ops::delete::handler(v0).await;
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
...
pub mod route_5 {
    ...
    async fn handler(v0: &pavex_session::Session<'_>) -> pavex::response::Response {
        let v1 = session_installation_sqlite::ops::get::handler(v0).await;
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
...
pub mod route_6 {
    ...
    async fn handler(v0: &pavex_session::Session<'_>) -> pavex::response::Response {
        let v1 = session_installation_sqlite::ops::get_struct::handler(v0).await;
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
...
pub mod route_7 {
    ...
    async fn handler(v0: &mut pavex_session::Session<'_>) -> pavex::response::Response {
        let v1 = session_installation_sqlite::ops::invalidate::handler(v0).await;
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
...
pub mod route_8 {
    ...
    async fn handler(v0: &mut pavex_session::Session<'_>) -> pavex::response::Response {
        let v1 = session_installation_sqlite::ops::remove::handler(v0).await;
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
...
pub mod route_9 {
    ...
    async fn handler(v0: &mut pavex_session::Session<'_>) -> pavex::response::Response {
        let v1 = session_installation_sqlite::ops::remove_raw::handler(v0).await;
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
...
pub mod route_10 {
    ...
    async fn handler(v0: &mut pavex_session::Session<'_>) -> pavex::response::Response {
        let v1 = session_installation_sqlite::ops::insert::handler(v0).await;
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
...
pub mod route_11 {
    ...
    async fn handler(v0: &mut pavex_session::Session<'_>) -> pavex::response::Response {
        let v1 = session_installation_sqlite::ops::insert_struct::handler(v0).await;
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
