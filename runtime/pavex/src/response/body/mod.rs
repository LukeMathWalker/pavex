//! Tools for building and manipulating [`Response`](crate::Response) bodies.
//!
...
mod typed_body {
    ...
    ///
    /// Check out [`Response::set_typed_body`](crate::Response) for more details
    ...
    pub trait TypedBody {
        ...
        /// returning this [`Response`](crate::Response).
        fn content_type(&self) -> HeaderValue;
