...
impl Router {
    ...
    fn router() -> matchit::Router<u32> {
        ...
        router.insert("/extern_c", 1u32).unwrap();
        router.insert("/no_input", 2u32).unwrap();
        router.insert("/no_input_no_output", 3u32).unwrap();
        router.insert("/no_output", 4u32).unwrap();
        router.insert("/two_inputs", 5u32).unwrap();
        router.insert("/unsafe", 6u32).unwrap();
        router.insert("/unsafe_extern_c", 7u32).unwrap();
        router
    }
    pub async fn route(
        &self,
...
pub mod route_6 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_9147b911::build_unsafe_fn_pointer();
        let v1 = app_9147b911::handler_unsafe(v0);
        <pavex::Response as pavex::IntoResponse>::into_response(v1)
    }
    struct Next0<T>
    where
...
pub mod route_7 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_9147b911::build_extern_c_fn_pointer();
        let v1 = app_9147b911::handler_extern_c(v0);
        <pavex::Response as pavex::IntoResponse>::into_response(v1)
    }
    struct Next0<T>
    where
...
pub mod route_8 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_9147b911::build_unsafe_extern_c_fn_pointer();
        let v1 = app_9147b911::handler_unsafe_extern_c(v0);
        <pavex::Response as pavex::IntoResponse>::into_response(v1)
    }
    struct Next0<T>
    where
