...
pub mod route_1 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = <app_a7fd6a2c::F as core::default::Default>::default();
        let v1 = <app_a7fd6a2c::A as app_a7fd6a2c::MyTrait>::a_method_that_returns_self();
        let v2 = <app_a7fd6a2c::A as app_a7fd6a2c::MyTrait>::a_method_that_borrows_self(
            &v1,
        );
        let v3 = <app_a7fd6a2c::B as app_a7fd6a2c::AnotherTrait>::a_method_that_consumes_self(
            v2,
        );
        let v4 = app_a7fd6a2c::handler(v1, v3, v0);
