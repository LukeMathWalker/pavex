...
pub mod route_1 {
    ...
    async fn stage_1<'a>(s_0: &'a app::LoggerFactory) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: &app::LoggerFactory) -> pavex::Response {
    ...
    async fn handler(v0: &app::LoggerFactory) -> pavex::Response {
