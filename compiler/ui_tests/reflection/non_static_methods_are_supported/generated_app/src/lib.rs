...
pub struct ApplicationState {
    pub logger_factory: app_40e90d31::LoggerFactory,
}
impl ApplicationState {
    ...
    async fn _new() -> crate::ApplicationState {
        let v0 = app_40e90d31::LoggerFactory::new();
            ...
            0u32 => {
                match &request_head.method {
                    &pavex::http::Method::GET => {
                        route_1::entrypoint(&state.logger_factory).await
                    }
                    _ => {
                        let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter([
                                pavex::http::Method::GET,
...
pub mod route_1 {
    pub async fn entrypoint<'a>(
        s_0: &'a app_40e90d31::LoggerFactory,
    ) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1<'a>(s_0: &'a app_40e90d31::LoggerFactory) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: &app_40e90d31::LoggerFactory) -> pavex::Response {
    ...
    async fn handler(v0: &app_40e90d31::LoggerFactory) -> pavex::Response {
        let v1 = app_40e90d31::LoggerFactory::logger(v0);
        let v2 = app_40e90d31::Streamer::new();
        let v3 = app_40e90d31::Streamer::stream_file(&v2, v1);
        <pavex::Response as pavex::IntoResponse>::into_response(v3)
    }
    struct Next0<'a, T>
    where
    ...
    {
        s_0: &'a app_40e90d31::LoggerFactory,
        next: fn(&'a app_40e90d31::LoggerFactory) -> T,
    }
    impl<'a, T> std::future::IntoFuture for Next0<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
