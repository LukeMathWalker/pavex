...
pub struct ApplicationState {
    pub arc_custom: alloc::sync::Arc<app_933292bd::Custom>,
    pub arc_mutex: alloc::sync::Arc<std::sync::Mutex<app_933292bd::Custom>>,
    pub arc_rw_lock: alloc::sync::Arc<std::sync::RwLock<app_933292bd::Custom>>,
}
impl ApplicationState {
    ...
    async fn _new() -> crate::ApplicationState {
        let v0 = app_933292bd::arc_rwlock();
        let v1 = app_933292bd::arc_mutex();
        let v2 = app_933292bd::arc();
...
pub mod route_1 {
    pub async fn entrypoint<'a, 'b, 'c>(
        s_0: &'a alloc::sync::Arc<app_933292bd::Custom>,
        s_1: &'b alloc::sync::Arc<std::sync::Mutex<app_933292bd::Custom>>,
        s_2: &'c alloc::sync::Arc<std::sync::RwLock<app_933292bd::Custom>>,
    ) -> pavex::Response {
    ...
    async fn wrapping_0(
        v0: &alloc::sync::Arc<app_933292bd::Custom>,
        v1: &alloc::sync::Arc<std::sync::Mutex<app_933292bd::Custom>>,
        v2: &alloc::sync::Arc<std::sync::RwLock<app_933292bd::Custom>>,
    ) -> pavex::Response {
    ...
    async fn handler(
        ...
        let v3 = app_933292bd::route_handler(v0, v1, v2);
        ...
        T: std::future::Future<Output = pavex::Response>,
    {
        ...
        s_2: &'c alloc::sync::Arc<std::sync::RwLock<app_933292bd::Custom>>,
        next: fn(
            &'a alloc::sync::Arc<app_933292bd::Custom>,
            &'b alloc::sync::Arc<std::sync::Mutex<app_933292bd::Custom>>,
            &'c alloc::sync::Arc<std::sync::RwLock<app_933292bd::Custom>>,
        ) -> T,
    }
