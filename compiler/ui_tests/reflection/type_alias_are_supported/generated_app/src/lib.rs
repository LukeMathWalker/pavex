...
impl ApplicationState {
    ...
    async fn _new(
        ...
        let v4 = app_f8f62968::constructor_with_output_tuple();
...
pub mod route_1 {
    ...
    async fn handler(
        ...
        let v6 = app_f8f62968::mixed_generics(v0);
        let v7 = dep_f8f62968::DoubleLifetimeType::new(v1, v0);
        let v8 = app_f8f62968::handler_with_input_tuple(v2, v1, v3, &v7, v6, v4, v5);
        <pavex::Response as pavex::IntoResponse>::into_response(v8)
    }
