...
pub mod route_1 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_88bca0dc::route_response();
...
pub mod route_2 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_88bca0dc::route_status_code();
...
pub mod route_3 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_88bca0dc::route_parts();
        <http::response::Parts as pavex::IntoResponse>::into_response(v0)
    }
    struct Next0<T>
    where
        T: std::future::Future<Output = pavex::Response>,
...
pub mod route_4 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_88bca0dc::route_response_head();
        <pavex::response::ResponseHead as pavex::IntoResponse>::into_response(v0)
    }
    struct Next0<T>
    where
        T: std::future::Future<Output = pavex::Response>,
