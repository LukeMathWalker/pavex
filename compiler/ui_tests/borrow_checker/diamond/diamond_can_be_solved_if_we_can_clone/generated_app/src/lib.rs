...
pub mod route_1 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_e8f51606::a();
        let v1 = app_e8f51606::b();
        let v2 = <app_e8f51606::B as core::clone::Clone>::clone(&v1);
        let v3 = app_e8f51606::d(&v0, v2);
        let v4 = app_e8f51606::c(v0, &v1);
        let v5 = app_e8f51606::handler(v4, v3);
