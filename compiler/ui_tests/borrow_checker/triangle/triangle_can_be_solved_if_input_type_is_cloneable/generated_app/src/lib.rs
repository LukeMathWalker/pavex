...
pub mod route_1 {
    pub async fn entrypoint(s_0: app_30dedb44::A) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: app_30dedb44::A) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: app_30dedb44::A) -> pavex::Response {
    ...
    async fn handler(v0: app_30dedb44::A) -> pavex::Response {
        let v1 = <app_30dedb44::A as core::clone::Clone>::clone(&v0);
        let v2 = app_30dedb44::b(v1);
        let v3 = app_30dedb44::handler(&v0, v2);
        <pavex::Response as pavex::IntoResponse>::into_response(v3)
    }
    struct Next0<T>
    where
