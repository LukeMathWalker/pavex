...
pub mod route_0 {
    ...
    async fn wrapping_1(v0: &pavex::router::AllowedMethods) -> pavex::Response {
        ...
        let v2 = pavex::middleware::Next::new(v1);
        let v3 = app_c4ef979d::a();
        let v4 = app_c4ef979d::mw(v3, v2);
...
pub mod route_1 {
    ...
    async fn stage_2<'a>(s_0: &'a app_c4ef979d::A) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    ...
    async fn wrapping_1() -> pavex::Response {
        let v0 = app_c4ef979d::a();
        let v1 = crate::route_1::Next1 {
            s_0: &v0,
            next: stage_2,
        };
        let v2 = pavex::middleware::Next::new(v1);
        let v3 = <app_c4ef979d::A as core::clone::Clone>::clone(&v0);
        let v4 = app_c4ef979d::mw(v3, v2);
        <pavex::Response as pavex::IntoResponse>::into_response(v4)
    }
    async fn handler(v0: &app_c4ef979d::A) -> pavex::Response {
        let v1 = app_c4ef979d::handler(v0);
        <pavex::Response as pavex::IntoResponse>::into_response(v1)
    }
    struct Next0<T>
    where
    ...
    where
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a app_c4ef979d::A,
        next: fn(&'a app_c4ef979d::A) -> T,
    }
    impl<'a, T> std::future::IntoFuture for Next1<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
