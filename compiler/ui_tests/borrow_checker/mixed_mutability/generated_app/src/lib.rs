...
pub mod route_0 {
    ...
    async fn wrapping_1(v0: &pavex::router::AllowedMethods) -> pavex::Response {
        let v1 = app_7c2a5f14::a();
        let v2 = app_7c2a5f14::c(&v1);
        let v3 = crate::route_0::Next1 {
            s_0: v0,
            next: stage_2,
        };
        let v4 = pavex::middleware::Next::new(v3);
        let v5 = app_7c2a5f14::wrapper(v4, v2);
...
pub mod route_1 {
    ...
    async fn stage_2<'a>(s_0: &'a mut app_7c2a5f14::A) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    ...
    async fn wrapping_1() -> pavex::Response {
        let mut v0 = app_7c2a5f14::a();
        let v1 = app_7c2a5f14::c(&v0);
        let v2 = crate::route_1::Next1 {
            s_0: &mut v0,
            next: stage_2,
        };
        let v3 = pavex::middleware::Next::new(v2);
        let v4 = app_7c2a5f14::wrapper(v3, v1);
        <pavex::Response as pavex::IntoResponse>::into_response(v4)
    }
    async fn handler(v0: &mut app_7c2a5f14::A) -> pavex::Response {
        let v1 = app_7c2a5f14::b(v0);
        let v2 = app_7c2a5f14::handler(v1, v0);
        <pavex::Response as pavex::IntoResponse>::into_response(v2)
    }
    struct Next0<T>
    where
    ...
    where
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a mut app_7c2a5f14::A,
        next: fn(&'a mut app_7c2a5f14::A) -> T,
    }
    impl<'a, T> std::future::IntoFuture for Next1<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
