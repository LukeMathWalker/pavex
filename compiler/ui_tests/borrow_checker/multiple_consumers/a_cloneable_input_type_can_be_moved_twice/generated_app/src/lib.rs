...
pub mod route_1 {
    pub async fn entrypoint(s_0: app_a248c801::A) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: app_a248c801::A) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: app_a248c801::A) -> pavex::Response {
    ...
    async fn handler(v0: app_a248c801::A) -> pavex::Response {
        let v1 = <app_a248c801::A as core::clone::Clone>::clone(&v0);
        let v2 = app_a248c801::b(v1);
        let v3 = app_a248c801::c(v0);
        let v4 = app_a248c801::handler(v2, v3);
