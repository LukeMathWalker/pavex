...
pub struct ApplicationState {
    pub b: app_8cdd5f4a::B,
    pub c: app_8cdd5f4a::C,
}
impl ApplicationState {
    ...
    async fn _new() -> Result<crate::ApplicationState, crate::ApplicationStateError> {
        ...
        let v2 = <app_8cdd5f4a::A as core::clone::Clone>::clone(&v1);
        let v3 = app_8cdd5f4a::b(v2);
        let v4 = app_8cdd5f4a::c(v1);
        let v5 = match v4 {
            Ok(ok) => ok,
            Err(v5) => {
                return {
            ...
            0u32 => {
                match &request_head.method {
                    &pavex::http::Method::GET => {
                        route_1::entrypoint(&state.c, &state.b).await
                    }
                    _ => {
                        let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter([
                                pavex::http::Method::GET,
...
pub mod route_1 {
    pub async fn entrypoint<'a, 'b>(
        s_0: &'a app_8cdd5f4a::C,
        s_1: &'b app_8cdd5f4a::B,
    ) -> pavex::Response {
    ...
    async fn wrapping_0(v0: &app_8cdd5f4a::C, v1: &app_8cdd5f4a::B) -> pavex::Response {
    ...
    async fn handler(v0: &app_8cdd5f4a::C, v1: &app_8cdd5f4a::B) -> pavex::Response {
        let v2 = app_8cdd5f4a::handler(v0, v1);
        ...
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a app_8cdd5f4a::C,
        s_1: &'b app_8cdd5f4a::B,
        next: fn(&'a app_8cdd5f4a::C, &'b app_8cdd5f4a::B) -> T,
    }
