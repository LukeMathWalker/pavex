...
pub mod route_1 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_8769849e::a();
        let v1 = <app_8769849e::A as core::clone::Clone>::clone(&v0);
        let v2 = app_8769849e::b(v1);
        let v3 = app_8769849e::c(v0);
        let v4 = app_8769849e::handler(v2, v3);
