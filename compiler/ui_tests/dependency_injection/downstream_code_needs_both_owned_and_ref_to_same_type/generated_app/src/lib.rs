...
pub mod route_0 {
    ...
    async fn wrapping_1(v0: &pavex::router::AllowedMethods) -> pavex::Response {
        let v1 = app_40ab089d::Scoped::new();
        ...
        let v4 = <app_40ab089d::Scoped as core::clone::Clone>::clone(&v1);
        let v5 = app_40ab089d::mw(v4, v3);
        <pavex::Response as pavex::IntoResponse>::into_response(v5)
    }
    async fn wrapping_2(
        v0: &pavex::router::AllowedMethods,
        v1: &app_40ab089d::Scoped,
    ) -> pavex::Response {
        let v2 = crate::route_0::Next2 {
            s_0: v0,
            next: stage_3,
        };
        let v3 = pavex::middleware::Next::new(v2);
        let v4 = app_40ab089d::mw2(v1, v3);
        ...
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a pavex::router::AllowedMethods,
        s_1: &'b app_40ab089d::Scoped,
        next: fn(&'a pavex::router::AllowedMethods, &'b app_40ab089d::Scoped) -> T,
    }
...
pub mod route_1 {
    ...
    async fn stage_2(s_0: app_40ab089d::Scoped) -> pavex::Response {
        let response = wrapping_2(s_0).await;
        response
    }
    async fn stage_3(s_0: app_40ab089d::Scoped) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    ...
    async fn wrapping_1() -> pavex::Response {
        let v0 = app_40ab089d::Scoped::new();
        let v1 = <app_40ab089d::Scoped as core::clone::Clone>::clone(&v0);
        let v2 = crate::route_1::Next1 {
            s_0: v0,
            next: stage_2,
        };
        let v3 = pavex::middleware::Next::new(v2);
        let v4 = app_40ab089d::mw(v1, v3);
        <pavex::Response as pavex::IntoResponse>::into_response(v4)
    }
    async fn wrapping_2(v0: app_40ab089d::Scoped) -> pavex::Response {
        let v1 = <app_40ab089d::Scoped as core::clone::Clone>::clone(&v0);
        ...
        let v3 = pavex::middleware::Next::new(v2);
        let v4 = app_40ab089d::mw2(&v0, v3);
        <pavex::Response as pavex::IntoResponse>::into_response(v4)
    }
    async fn handler(v0: app_40ab089d::Scoped) -> pavex::Response {
        let v1 = app_40ab089d::handler(v0);
        <pavex::Response as pavex::IntoResponse>::into_response(v1)
    }
    struct Next0<T>
    where
    ...
    where
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: app_40ab089d::Scoped,
        next: fn(app_40ab089d::Scoped) -> T,
    }
