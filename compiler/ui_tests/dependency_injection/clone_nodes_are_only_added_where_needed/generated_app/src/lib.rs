...
pub struct ApplicationState {
    pub singleton: app_366b29bf::Singleton,
}
impl ApplicationState {
    ...
    async fn _new() -> crate::ApplicationState {
        let v0 = app_366b29bf::Singleton::new();
    ...
    pub async fn route(
        ...
        let Ok(matched_route) = self.router.at(&request_head.target.path()) else {
            let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter(
                ...
                .into();
            return route_0::entrypoint(state.singleton.clone(), &allowed_methods).await;
        };
        match matched_route.value {
            0u32 => {
                match &request_head.method {
                    &pavex::http::Method::GET => {
                        route_1::entrypoint(state.singleton.clone()).await
                    }
                    _ => {
                        let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter([
                                pavex::http::Method::GET,
                            ...
                            .into();
                        route_0::entrypoint(state.singleton.clone(), &allowed_methods)
                            .await
                    }
                }
            }
...
pub mod route_0 {
        ...
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a pavex::router::AllowedMethods,
        s_1: app_366b29bf::Singleton,
        next: fn(&'a pavex::router::AllowedMethods, app_366b29bf::Singleton) -> T,
    }
...
pub mod route_1 {
    pub async fn entrypoint(s_0: app_366b29bf::Singleton) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: app_366b29bf::Singleton) -> pavex::Response {
        let response = wrapping_1(s_0).await;
        response
    }
    async fn stage_2(s_0: app_366b29bf::Singleton) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: app_366b29bf::Singleton) -> pavex::Response {
    ...
    async fn wrapping_1(v0: app_366b29bf::Singleton) -> pavex::Response {
        let v1 = <app_366b29bf::Singleton as core::clone::Clone>::clone(&v0);
    ...
    async fn handler(v0: app_366b29bf::Singleton) -> pavex::Response {
        let v1 = app_366b29bf::handler(v0);
        <pavex::Response as pavex::IntoResponse>::into_response(v1)
    }
    struct Next0<T>
    where
    ...
    {
        s_0: app_366b29bf::Singleton,
        next: fn(app_366b29bf::Singleton) -> T,
    }
