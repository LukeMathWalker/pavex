...
pub mod route_1 {
    pub async fn entrypoint<'a>(s_0: &'a app::Singleton) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1<'a>(s_0: &'a app::Singleton) -> pavex::Response {
        let response = wrapping_1(s_0).await;
        response
    }
    async fn stage_2<'a>(s_0: &'a app::RequestScoped) -> pavex::Response {
        let response = handler(s_0).await;
        let response = post_processing_0(response, s_0).await;
        response
    }
    async fn wrapping_0(v0: &app::Singleton) -> pavex::Response {
    ...
    async fn wrapping_1(v0: &app::Singleton) -> pavex::Response {
    ...
    async fn handler(v0: &app::RequestScoped) -> pavex::Response {
