...
pub struct ApplicationState {
    pub singleton: app_8b5f0867::Singleton,
}
impl ApplicationState {
    ...
    async fn _new() -> crate::ApplicationState {
        let v0 = app_8b5f0867::Singleton::new();
    ...
    pub async fn route(
        ...
        let Ok(matched_route) = self.router.at(&request_head.target.path()) else {
            let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter(
                ...
                .into();
            return route_0::entrypoint(&state.singleton, &allowed_methods).await;
        };
        match matched_route.value {
            0u32 => {
                match &request_head.method {
                    &pavex::http::Method::GET => {
                        route_1::entrypoint(&state.singleton).await
                    }
                    _ => {
                        let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter([
                                pavex::http::Method::GET,
                            ...
                            .into();
                        route_0::entrypoint(&state.singleton, &allowed_methods).await
                    }
                }
            }
...
pub mod route_0 {
    ...
    async fn post_processing_0(
        v0: pavex::Response,
        v1: &app_8b5f0867::Singleton,
    ) -> pavex::Response {
        let v2 = app_8b5f0867::request_scoped(v1);
        let v3 = app_8b5f0867::post(v0, &v2);
        ...
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a app_8b5f0867::Singleton,
        s_1: &'b pavex::router::AllowedMethods,
        next: fn(&'a app_8b5f0867::Singleton, &'b pavex::router::AllowedMethods) -> T,
    }
...
pub mod route_1 {
    pub async fn entrypoint<'a>(s_0: &'a app_8b5f0867::Singleton) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1<'a>(s_0: &'a app_8b5f0867::Singleton) -> pavex::Response {
        let response = wrapping_1(s_0).await;
        response
    }
    async fn stage_2<'a>(s_0: &'a app_8b5f0867::RequestScoped) -> pavex::Response {
        let response = handler(s_0).await;
        let response = post_processing_0(response, s_0).await;
        response
    }
    async fn wrapping_0(v0: &app_8b5f0867::Singleton) -> pavex::Response {
    ...
    async fn wrapping_1(v0: &app_8b5f0867::Singleton) -> pavex::Response {
        let v1 = app_8b5f0867::request_scoped(v0);
    ...
    async fn handler(v0: &app_8b5f0867::RequestScoped) -> pavex::Response {
        let v1 = app_8b5f0867::handler(v0);
        <pavex::Response as pavex::IntoResponse>::into_response(v1)
    }
    async fn post_processing_0(
        v0: pavex::Response,
        v1: &app_8b5f0867::RequestScoped,
    ) -> pavex::Response {
        let v2 = app_8b5f0867::post(v0, v1);
    ...
    {
        s_0: &'a app_8b5f0867::Singleton,
        next: fn(&'a app_8b5f0867::Singleton) -> T,
    }
    ...
    where
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a app_8b5f0867::RequestScoped,
        next: fn(&'a app_8b5f0867::RequestScoped) -> T,
    }
