...
pub struct ApplicationState {
    pub singleton: app_c266691d::Singleton,
}
impl ApplicationState {
    ...
    async fn _new() -> crate::ApplicationState {
        let v0 = app_c266691d::Singleton::new();
...
pub mod route_1 {
    pub async fn entrypoint<'a>(s_0: &'a app_c266691d::Singleton) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1<'a>(s_0: &'a app_c266691d::Singleton) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: &app_c266691d::Singleton) -> pavex::Response {
    ...
    async fn handler(v0: &app_c266691d::Singleton) -> pavex::Response {
        let v1 = app_c266691d::transient();
        let v2 = app_c266691d::request_scoped();
        let v3 = app_c266691d::stream_file(v0, &v2, &v1);
        <pavex::Response as pavex::IntoResponse>::into_response(v3)
    }
    struct Next0<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a app_c266691d::Singleton,
        next: fn(&'a app_c266691d::Singleton) -> T,
    }
    impl<'a, T> std::future::IntoFuture for Next0<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
