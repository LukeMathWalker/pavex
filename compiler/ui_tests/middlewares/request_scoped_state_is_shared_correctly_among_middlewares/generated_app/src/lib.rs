...
pub mod route_0 {
    ...
    async fn pre_processing_0(v0: &app_4b6f5359::A) -> pavex::middleware::Processing {
        app_4b6f5359::pre(v0)
    }
    async fn wrapping_1(
        ...
        let v3 = pavex::middleware::Next::new(v2);
        let v4 = app_4b6f5359::wrap(v3, v1);
        <pavex::Response as pavex::IntoResponse>::into_response(v4)
    }
    ...
    async fn post_processing_0(
        ...
        let v2 = app_4b6f5359::post(v0, v1);
        ...
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a pavex::router::AllowedMethods,
        s_1: app_4b6f5359::A,
        next: fn(&'a pavex::router::AllowedMethods, app_4b6f5359::A) -> T,
    }
...
pub mod route_1 {
    ...
    async fn stage_1(s_0: app_4b6f5359::A) -> pavex::Response {
        let response = 'incoming: {
    ...
    async fn wrapping_1(v0: &app_4b6f5359::A) -> pavex::Response {
        let v1 = crate::route_1::Next1 {
            next: stage_2,
        };
        let v2 = pavex::middleware::Next::new(v1);
        let v3 = app_4b6f5359::wrap(v2, v0);
        <pavex::Response as pavex::IntoResponse>::into_response(v3)
    }
    async fn handler() -> pavex::Response {
        let v0 = app_4b6f5359::handler();
