...
pub mod route_0 {
    ...
    async fn wrapping_1(v0: &pavex::router::AllowedMethods) -> pavex::Response {
        let v1 = app_dc1710a5::c();
        let v2 = app_dc1710a5::a();
        let v3 = app_dc1710a5::b(&v2, &v1);
        let v4 = crate::route_0::Next1 {
            s_0: v0,
            next: stage_2,
        };
        let v5 = pavex::middleware::Next::new(v4);
        let v6 = app_dc1710a5::mw(v5, v3);
...
pub mod route_1 {
    ...
    async fn stage_2<'a, 'b>(
        s_0: &'a app_dc1710a5::A,
        s_1: &'b app_dc1710a5::C,
    ) -> pavex::Response {
    ...
    async fn wrapping_1() -> pavex::Response {
        let v0 = app_dc1710a5::c();
        let v1 = app_dc1710a5::a();
        let v2 = app_dc1710a5::b(&v1, &v0);
        ...
        let v5 = app_dc1710a5::mw(v4, v2);
        <pavex::Response as pavex::IntoResponse>::into_response(v5)
    }
    async fn handler(v0: &app_dc1710a5::A, v1: &app_dc1710a5::C) -> pavex::Response {
        let v2 = app_dc1710a5::handler(v0, v1);
        <pavex::Response as pavex::IntoResponse>::into_response(v2)
    }
    struct Next0<T>
    where
        ...
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a app_dc1710a5::A,
        s_1: &'b app_dc1710a5::C,
        next: fn(&'a app_dc1710a5::A, &'b app_dc1710a5::C) -> T,
    }
