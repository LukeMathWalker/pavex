...
pub mod route_1 {
    ...
    async fn stage_1(mut s_0: app_db1cbdff::A) -> pavex::Response {
        let response = wrapping_1(&mut s_0).await;
        let response = post_processing_0(response, s_0).await;
        response
    }
    async fn stage_2<'a>(s_0: &'a mut app_db1cbdff::A) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    ...
    async fn wrapping_1(v0: &mut app_db1cbdff::A) -> pavex::Response {
    ...
    async fn handler(v0: &mut app_db1cbdff::A) -> pavex::Response {
