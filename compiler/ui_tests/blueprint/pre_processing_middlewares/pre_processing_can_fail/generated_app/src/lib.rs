...
pub mod route_0 {
    ...
    async fn pre_processing_0() -> pavex::middleware::Processing {
        let v0 = app_35634115::via_attribute();
        let v1 = match v0 {
            Ok(ok) => ok,
            Err(v1) => {
                return {
                    let v2 = app_35634115::CustomError::into_response(&v1);
                    let v3 = <pavex::Response as pavex::IntoResponse>::into_response(v2);
    ...
    async fn pre_processing_1() -> pavex::middleware::Processing {
        let v0 = app_35634115::override_in_blueprint();
        let v1 = match v0 {
            Ok(ok) => ok,
            Err(v1) => {
                return {
                    let v2 = app_35634115::CustomError::into_response_override(&v1);
                    let v3 = <pavex::Response as pavex::IntoResponse>::into_response(v2);
                    pavex::middleware::Processing::EarlyReturn(v3)
                };
            }
