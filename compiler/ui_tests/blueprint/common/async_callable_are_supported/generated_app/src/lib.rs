...
pub struct ApplicationState {
    pub http_client: app_c62eca9e::HttpClient,
}
impl ApplicationState {
    pub async fn new(
        _app_config: crate::ApplicationConfig,
        v0: app_c62eca9e::Config,
    ) -> Result<crate::ApplicationState, crate::ApplicationStateError> {
        Ok(Self::_new(v0).await)
    }
    async fn _new(v0: app_c62eca9e::Config) -> crate::ApplicationState {
        let v1 = app_c62eca9e::http_client(v0).await;
            ...
            0u32 => {
                match &request_head.method {
                    &pavex::http::Method::GET => {
                        route_1::entrypoint(request_head, &state.http_client).await
                    }
                    _ => {
                        let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter([
                                pavex::http::Method::GET,
...
pub mod route_1 {
    ...
    async fn handler(
        ...
        let v2 = app_c62eca9e::logger().await;
        let v3 = app_c62eca9e::extract_path(v0).await;
        let v4 = app_c62eca9e::stream_file(v3, v2, v1).await;
        <pavex::Response as pavex::IntoResponse>::into_response(v4)
    }
    struct Next0<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: pavex::request::RequestHead,
        s_1: &'a app_c62eca9e::HttpClient,
        next: fn(pavex::request::RequestHead, &'a app_c62eca9e::HttpClient) -> T,
    }
    impl<'a, T> std::future::IntoFuture for Next0<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
