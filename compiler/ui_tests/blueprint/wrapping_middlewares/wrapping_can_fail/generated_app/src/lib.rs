...
pub mod route_0 {
    ...
    async fn wrapping_1(v0: &pavex::router::AllowedMethods) -> pavex::Response {
        ...
        let v2 = pavex::middleware::Next::new(v1);
        let v3 = app_04686649::via_attribute(v2);
        let v4 = match v3 {
            Ok(ok) => ok,
            Err(v4) => {
                return {
                    let v5 = app_04686649::CustomError::into_response(&v4);
    ...
    async fn wrapping_2(v0: &pavex::router::AllowedMethods) -> pavex::Response {
        ...
        let v2 = pavex::middleware::Next::new(v1);
        let v3 = app_04686649::override_in_blueprint(v2);
        let v4 = match v3 {
            Ok(ok) => ok,
            Err(v4) => {
                return {
                    let v5 = app_04686649::CustomError::into_response_override(&v4);
                    <pavex::Response as pavex::IntoResponse>::into_response(v5)
                };
            }
        };
...
pub mod route_1 {
    ...
    async fn wrapping_1() -> pavex::Response {
        ...
        let v1 = pavex::middleware::Next::new(v0);
        let v2 = app_04686649::via_attribute(v1);
        let v3 = match v2 {
            Ok(ok) => ok,
            Err(v3) => {
                return {
                    let v4 = app_04686649::CustomError::into_response(&v3);
                    <pavex::Response as pavex::IntoResponse>::into_response(v4)
                };
            }
        };
    ...
    async fn wrapping_2() -> pavex::Response {
        ...
        let v1 = pavex::middleware::Next::new(v0);
        let v2 = app_04686649::override_in_blueprint(v1);
        let v3 = match v2 {
            Ok(ok) => ok,
            Err(v3) => {
                return {
                    let v4 = app_04686649::CustomError::into_response_override(&v3);
                    <pavex::Response as pavex::IntoResponse>::into_response(v4)
                };
            }
        };
