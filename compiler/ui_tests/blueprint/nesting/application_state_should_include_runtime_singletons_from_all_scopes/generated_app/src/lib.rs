...
impl ApplicationState {
    ...
    async fn _new() -> crate::ApplicationState {
        let v0 = app_ea86e18a::parent_singleton();
        let v1 = app_ea86e18a::singleton_dep();
        let v2 = app_ea86e18a::nested_singleton(v1);
...
pub mod route_0 {
    pub async fn entrypoint(s_0: u64) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: u64) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: u64) -> pavex::Response {
    ...
    async fn handler(v0: u64) -> pavex::Response {
        let v1 = app_ea86e18a::parent_handler(v0);
...
pub mod route_2 {
    pub async fn entrypoint(s_0: u32) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: u32) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: u32) -> pavex::Response {
    ...
    async fn handler(v0: u32) -> pavex::Response {
        let v1 = app_ea86e18a::child_handler(v0);
        <http::StatusCode as pavex::IntoResponse>::into_response(v1)
    }
    struct Next0<T>
    where
