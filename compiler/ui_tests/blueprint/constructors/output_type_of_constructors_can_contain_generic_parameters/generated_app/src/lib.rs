...
pub mod route_1 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_ea979460::fallible();
        let v1 = match v0 {
            Ok(ok) => ok,
            Err(v1) => {
                return {
                    let v2 = app_ea979460::error_handler(&v1);
                    <pavex::Response as pavex::IntoResponse>::into_response(v2)
                };
            }
        };
        ...
        let v6 = app_ea979460::fallible_with_generic_error2();
        let v7 = match v6 {
            Ok(ok) => ok,
            Err(v7) => {
                return {
                    let v8 = app_ea979460::json();
                    let v9 = app_ea979460::doubly_generic_error_handler(&v7, &v8);
        ...
        let v11 = app_ea979460::handler(v8, v10, &v9, v1, v3, &v5, &v7);
