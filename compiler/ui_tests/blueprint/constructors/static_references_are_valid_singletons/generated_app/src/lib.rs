...
impl ApplicationState {
    ...
    async fn _new() -> crate::ApplicationState {
        let v0 = app_d0f81bc0::static_u8();
        let v1 = app_d0f81bc0::static_str();
            ...
            0u32 => {
                match &request_head.method {
                    &pavex::http::Method::GET => {
                        route_1::entrypoint(state.str_, state.u8_).await
                    }
                    _ => {
                        let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter([
                                pavex::http::Method::GET,
...
pub mod route_1 {
    pub async fn entrypoint(s_0: &'static str, s_1: &'static u8) -> pavex::Response {
        let response = wrapping_0(s_0, s_1).await;
        response
    }
    async fn stage_1(s_0: &'static u8, s_1: &'static str) -> pavex::Response {
        let response = handler(s_0, s_1).await;
        response
    }
    async fn wrapping_0(v0: &'static str, v1: &'static u8) -> pavex::Response {
    ...
    async fn handler(v0: &'static u8, v1: &'static str) -> pavex::Response {
        let v2 = app_d0f81bc0::handler(v1, v0);
