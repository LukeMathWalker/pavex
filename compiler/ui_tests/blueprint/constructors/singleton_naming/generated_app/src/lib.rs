...
pub struct ApplicationState {
    pub app_255_f_0769_a_singleton: app_255f0769::a::Singleton,
    pub app_255_f_0769_singleton: app_255f0769::Singleton,
    pub generic_string: app_255f0769::Generic<alloc::string::String>,
    pub generic_u64_: app_255f0769::Generic<u64>,
    pub type_: app_255f0769::Type,
}
impl ApplicationState {
    ...
    async fn _new() -> crate::ApplicationState {
        let v0 = app_255f0769::Type::new();
        let v1 = app_255f0769::Generic::new();
        let v2 = app_255f0769::Generic::new();
        let v3 = app_255f0769::Singleton::new();
        let v4 = app_255f0769::a::Singleton::new();
...
pub mod route_1 {
    pub async fn entrypoint<'a, 'b, 'c, 'd, 'e>(
        s_0: &'a app_255f0769::Type,
        s_1: &'b app_255f0769::Generic<alloc::string::String>,
        s_2: &'c app_255f0769::Generic<u64>,
        s_3: &'d app_255f0769::Singleton,
        s_4: &'e app_255f0769::a::Singleton,
    ) -> pavex::Response {
    ...
    async fn wrapping_0(
        v0: &app_255f0769::Type,
        v1: &app_255f0769::Generic<alloc::string::String>,
        v2: &app_255f0769::Generic<u64>,
        v3: &app_255f0769::Singleton,
        v4: &app_255f0769::a::Singleton,
    ) -> pavex::Response {
    ...
    async fn handler(
        ...
        let v5 = app_255f0769::handler(v0, v1, v2, v3, v4);
        ...
        T: std::future::Future<Output = pavex::Response>,
    {
        ...
        next: fn(
            &'a app_255f0769::Type,
            &'b app_255f0769::Generic<alloc::string::String>,
            &'c app_255f0769::Generic<u64>,
            &'d app_255f0769::Singleton,
            &'e app_255f0769::a::Singleton,
        ) -> T,
    }
