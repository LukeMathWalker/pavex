...
impl Router {
    ...
    fn router() -> matchit::Router<u32> {
        ...
        router.insert("/with_observer", 0u32).unwrap();
        router.insert("/without_observer", 1u32).unwrap();
        router
    }
    pub async fn route(
        &self,
...
pub mod route_0 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_40a0f751::fallible_constructor();
        let v1 = match v0 {
            Ok(ok) => ok,
            Err(v1) => {
                return {
                    let v2 = pavex::Error::new(v1);
                    let v3 = app_40a0f751::error_handler(&v2);
                    <pavex::Response as pavex::IntoResponse>::into_response(v3)
                };
            }
        };
        let v2 = app_40a0f751::generic_fallible_constructor();
        let v3 = match v2 {
            Ok(ok) => ok,
            Err(v3) => {
                return {
                    let v4 = pavex::Error::new(v3);
                    let v5 = app_40a0f751::error_handler(&v4);
                    <pavex::Response as pavex::IntoResponse>::into_response(v5)
                };
            }
        };
        let v4 = app_40a0f751::without_observer(v1, v3);
        ...
        let v1 = match v0 {
            ...
            Err(v1) => {
                return {
                    let v2 = pavex::Error::new(v1);
                    let v3 = app_40a0f751::error_handler(&v2);
                    app_40a0f751::error_observer(&v2);
                    <pavex::Response as pavex::IntoResponse>::into_response(v3)
                };
            }
        };
        ...
        let v3 = match v2 {
            ...
            Err(v3) => {
                return {
                    let v4 = pavex::Error::new(v3);
                    let v5 = app_40a0f751::error_handler(&v4);
                    app_40a0f751::error_observer(&v4);
                    <pavex::Response as pavex::IntoResponse>::into_response(v5)
                };
            }
        };
        let v4 = app_40a0f751::with_observer(v1, v3);
        <pavex::Response as pavex::IntoResponse>::into_response(v4)
    }
    struct Next0<T>
    where
