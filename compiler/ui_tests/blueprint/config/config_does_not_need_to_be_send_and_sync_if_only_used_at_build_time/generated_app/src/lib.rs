...
pub struct ApplicationConfig {
    pub a: app_4587d126::A,
}
pub struct ApplicationState {
    pub b: app_4587d126::B,
}
impl ApplicationState {
    ...
    async fn _new(v0: &app_4587d126::A) -> crate::ApplicationState {
        let v1 = app_4587d126::b(v0);
        ...
        match matched_route.value {
            0u32 => {
                match &request_head.method {
                    &pavex::http::Method::GET => route_1::entrypoint(&state.b).await,
                    _ => {
                        let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter([
...
pub mod route_1 {
    pub async fn entrypoint<'a>(s_0: &'a app_4587d126::B) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1<'a>(s_0: &'a app_4587d126::B) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: &app_4587d126::B) -> pavex::Response {
    ...
    async fn handler(v0: &app_4587d126::B) -> pavex::Response {
        let v1 = app_4587d126::handler(v0);
        <pavex::Response as pavex::IntoResponse>::into_response(v1)
    }
    struct Next0<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a app_4587d126::B,
        next: fn(&'a app_4587d126::B) -> T,
    }
    impl<'a, T> std::future::IntoFuture for Next0<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
