...
pub struct ApplicationConfig {
    pub a: app_b5d21f5b::A,
    #[serde(default)]
    pub b: app_b5d21f5b::B,
    pub c: app_b5d21f5b::C,
    pub e: app_b5d21f5b::E,
...
pub mod route_1 {
    pub async fn entrypoint<'a, 'b, 'c, 'd, 'e, 'f>(
        s_0: &'a app_b5d21f5b::A,
        s_1: &'b app_b5d21f5b::B,
        s_2: &'c app_b5d21f5b::C,
        s_3: &'d app_b5d21f5b::E,
        s_4: &'e dep_29415e2f::F,
        s_5: &'f dep_29415e2f::Z,
    ) -> pavex::Response {
    ...
    async fn handler(
        ...
        let v6 = app_b5d21f5b::handler(v0, v1, v2, v3, v4, v5);
