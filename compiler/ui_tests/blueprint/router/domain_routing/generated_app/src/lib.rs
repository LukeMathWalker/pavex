...
pub mod route_0 {
    ...
    async fn handler(v0: &pavex::request::RequestHead) -> pavex::Response {
        let v1 = app_6c2cfd5e::root_fallback(v0);
...
pub mod route_3 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_6c2cfd5e::ops_fallback();
        <pavex::Response as pavex::IntoResponse>::into_response(v0)
    }
    struct Next0<T>
    where
...
pub mod route_5 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_6c2cfd5e::base_login();
        <pavex::Response as pavex::IntoResponse>::into_response(v0)
    }
    struct Next0<T>
    where
...
pub mod route_6 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_6c2cfd5e::admin_root();
        <pavex::Response as pavex::IntoResponse>::into_response(v0)
    }
    struct Next0<T>
    where
...
pub mod route_7 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = app_6c2cfd5e::admin_fallback();
        <pavex::Response as pavex::IntoResponse>::into_response(v0)
    }
    struct Next0<T>
    where
