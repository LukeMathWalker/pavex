...
pub struct ApplicationState {
    pub a: app_4c9069e8::A,
    pub b: app_4c9069e8::B,
}
impl ApplicationState {
    ...
    async fn _new(v0: app_4c9069e8::A) -> crate::ApplicationState {
        let v1 = <app_4c9069e8::A as core::clone::Clone>::clone(&v0);
        let v2 = app_4c9069e8::b(v0);
            ...
            0u32 => {
                match &request_head.method {
                    &pavex::http::Method::GET => {
                        route_1::entrypoint(state.a.clone(), &state.b).await
                    }
                    _ => {
                        let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter([
                                pavex::http::Method::GET,
...
pub mod route_1 {
    ...
    async fn wrapping_0(v0: app_4c9069e8::A, v1: &app_4c9069e8::B) -> pavex::Response {
    ...
    async fn handler(v0: app_4c9069e8::A, v1: &app_4c9069e8::B) -> pavex::Response {
        let v2 = app_4c9069e8::handler(v0, v1);
        ...
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: app_4c9069e8::A,
        s_1: &'a app_4c9069e8::B,
        next: fn(app_4c9069e8::A, &'a app_4c9069e8::B) -> T,
    }
    impl<'a, T> std::future::IntoFuture for Next0<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
