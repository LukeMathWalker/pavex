...
impl ApplicationState {
    ...
    async fn _new(v0: app_776ff188::A) -> crate::ApplicationState {
        let v1 = app_776ff188::b(v0);
...
pub mod route_1 {
    pub async fn entrypoint<'a>(s_0: &'a app_776ff188::B) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1<'a>(s_0: &'a app_776ff188::B) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: &app_776ff188::B) -> pavex::Response {
    ...
    async fn handler(v0: &app_776ff188::B) -> pavex::Response {
        let v1 = app_776ff188::handler(v0);
        <pavex::Response as pavex::IntoResponse>::into_response(v1)
    }
    struct Next0<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
    {
        s_0: &'a app_776ff188::B,
        next: fn(&'a app_776ff188::B) -> T,
    }
    impl<'a, T> std::future::IntoFuture for Next0<'a, T>
    where
        T: std::future::Future<Output = pavex::Response>,
