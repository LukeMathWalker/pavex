...
use super::collection::CrateCollection;
...
pub struct Crate {
    ...
    pub(in crate::rustdoc) crate_id2package_id: Arc<RwLock<HashMap<CrateIdNeedle, PackageId>>>,
}
...
pub(crate) struct CrateCore {
    ...
    pub(in crate::rustdoc) krate: CrateData,
}
...
impl Crate {
    ...
    pub(super) fn get_summary_by_local_type_id(
        &self,
        id: &rustdoc_types::Id,
