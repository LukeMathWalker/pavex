        ...
        match matched_route.value {
            ...
            2u32 => match &request_head.method {
                &pavex::http::Method::GET => {
                    let connection_info =
                        connection_info.expect("Required `ConnectionInfo` is missing");
...
pub mod route_1 {
    pub async fn entrypoint(s_0: pavex::request::body::RawIncomingBody) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: pavex::request::body::RawIncomingBody) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: pavex::request::body::RawIncomingBody) -> pavex::Response {
    ...
    async fn handler(v0: pavex::request::body::RawIncomingBody) -> pavex::Response {
        let v1 = wire_data::body::raw_body(v0);
        <http::StatusCode as pavex::IntoResponse>::into_response(v1)
    }
    struct Next0<T>
    where
        T: std::future::Future<Output = pavex::Response>,
...
pub mod route_3 {
    pub async fn entrypoint(s_0: pavex::connection::ConnectionInfo) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: pavex::connection::ConnectionInfo) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: pavex::connection::ConnectionInfo) -> pavex::Response {
    ...
    async fn handler(v0: pavex::connection::ConnectionInfo) -> pavex::Response {
