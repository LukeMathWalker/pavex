...
impl Router {
    ...
    fn router() -> matchit::Router<u32> {
        ...
        router.insert("/consecutive/prefix//path", 1u32).unwrap();
        router.insert("/deep/home/{home_id}/room/{room_id}", 2u32).unwrap();
        router.insert("/home/", 3u32).unwrap();
        router.insert("/home/{home_id}", 4u32).unwrap();
        router
    }
    pub async fn route(
        &self,
...
pub mod route_1 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = path_prefixes::consecutive::handler();
...
pub mod route_2 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = path_prefixes::deep::get_room();
        <http::StatusCode as pavex::IntoResponse>::into_response(v0)
    }
    struct Next0<T>
    where
...
pub mod route_3 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = path_prefixes::intro::index();
        <http::StatusCode as pavex::IntoResponse>::into_response(v0)
    }
    struct Next0<T>
    where
...
pub mod route_4 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = path_prefixes::intro::home::list_homes();
        <http::StatusCode as pavex::IntoResponse>::into_response(v0)
    }
    struct Next0<T>
    where
...
pub mod route_5 {
    ...
    async fn handler() -> pavex::Response {
        let v0 = path_prefixes::intro::home::get_home();
        <http::StatusCode as pavex::IntoResponse>::into_response(v0)
    }
    struct Next0<T>
    where
