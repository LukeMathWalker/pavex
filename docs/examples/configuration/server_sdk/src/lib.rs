...
pub struct ApplicationState {
    pub postgres_config: configuration::postgres::PostgresConfig,
    pub server_config: configuration::server::ServerConfig,
}
impl ApplicationState {
    pub async fn new(
        app_config: crate::ApplicationConfig,
    ) -> Result<crate::ApplicationState, crate::ApplicationStateError> {
        Ok(Self::_new(app_config.server, app_config.postgres).await)
    }
    async fn _new(
        v0: configuration::server::ServerConfig,
        v1: configuration::postgres::PostgresConfig,
        ...
        match matched_route.value {
            0u32 => match &request_head.method {
                &pavex::http::Method::GET => {
                    route_1::entrypoint(&state.postgres_config, &state.server_config).await
                }
                _ => {
                    let allowed_methods: pavex::router::AllowedMethods =
...
pub mod route_1 {
    pub async fn entrypoint<'a, 'b>(
        s_0: &'a configuration::postgres::PostgresConfig,
        s_1: &'b configuration::server::ServerConfig,
    ) -> pavex::Response {
    ...
    async fn wrapping_0(
        v0: &configuration::postgres::PostgresConfig,
        v1: &configuration::server::ServerConfig,
    ) -> pavex::Response {
    ...
    async fn handler(
        ...
        let v2 = configuration::base::handler(v0, v1);
        ...
        T: std::future::Future<Output = pavex::Response>,
    {
        ...
        s_1: &'b configuration::server::ServerConfig,
        next: fn(
            &'a configuration::postgres::PostgresConfig,
            &'b configuration::server::ServerConfig,
        ) -> T,
    }
