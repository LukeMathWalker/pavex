...
pub mod route_0 {
    ...
    async fn stage_3<'a>(s_0: &'a pavex::router::AllowedMethods) -> pavex::Response {
        let response = wrapping_3(s_0).await;
        response
    }
    async fn stage_4<'a>(s_0: &'a pavex::router::AllowedMethods) -> pavex::Response {
    ...
    async fn wrapping_1(v0: &pavex::router::AllowedMethods) -> pavex::Response {
        ...
        let v2 = pavex::middleware::Next::new(v1);
        let v3 = wrapping::timeout::timeout(v2).await;
        let v4 = match v3 {
            Ok(ok) => ok,
            Err(v4) => {
                return {
                    let v5 = wrapping::errors::timeout_error_handler(&v4);
    ...
    async fn wrapping_2(v0: &pavex::router::AllowedMethods) -> pavex::Response {
        let v1 = crate::route_0::Next2 {
            s_0: v0,
            next: stage_3,
        };
        let v2 = pavex::middleware::Next::new(v1);
        let v3 = wrapping::logger::logger(v2).await;
        <pavex::Response as pavex::IntoResponse>::into_response(v3)
    }
    async fn wrapping_3(v0: &pavex::router::AllowedMethods) -> pavex::Response {
        let v1 = crate::route_0::Next3 {
            s_0: v0,
            next: stage_4,
        };
        let v2 = pavex::middleware::Next::new(v1);
        let v3 = wrapping::debug::debug_wrapper(v2).await;
        <pavex::Response as pavex::IntoResponse>::into_response(v3)
    }
...
pub mod route_1 {
    ...
    async fn stage_2() -> pavex::Response {
        let response = wrapping_2().await;
        response
    }
    async fn stage_3() -> pavex::Response {
        let response = wrapping_3().await;
        response
    }
    async fn stage_4() -> pavex::Response {
    ...
    async fn wrapping_1() -> pavex::Response {
        ...
        let v1 = pavex::middleware::Next::new(v0);
        let v2 = wrapping::timeout::timeout(v1).await;
        let v3 = match v2 {
            Ok(ok) => ok,
            Err(v3) => {
                return {
                    let v4 = wrapping::errors::timeout_error_handler(&v3);
                    <pavex::Response as pavex::IntoResponse>::into_response(v4)
                };
            }
        };
    ...
    async fn wrapping_2() -> pavex::Response {
        let v0 = crate::route_1::Next2 { next: stage_3 };
        let v1 = pavex::middleware::Next::new(v0);
        let v2 = wrapping::logger::logger(v1).await;
        <pavex::Response as pavex::IntoResponse>::into_response(v2)
    }
    async fn wrapping_3() -> pavex::Response {
        let v0 = crate::route_1::Next3 { next: stage_4 };
        let v1 = pavex::middleware::Next::new(v0);
        let v2 = wrapping::debug::debug_wrapper(v1).await;
        <pavex::Response as pavex::IntoResponse>::into_response(v2)
    }
    async fn handler() -> pavex::Response {
        let v0 = wrapping::routes::handler();
