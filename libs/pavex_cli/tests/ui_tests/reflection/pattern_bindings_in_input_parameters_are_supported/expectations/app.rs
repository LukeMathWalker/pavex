...
pub mod route_0 {
    pub async fn entrypoint(s_0: app::Streamer) -> pavex::response::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: app::Streamer) -> pavex::response::Response {
        let response = handler(s_0).await;
        response
    }
    pub async fn wrapping_0(v0: app::Streamer) -> pavex::response::Response {
    ...
    pub async fn handler(v0: app::Streamer) -> pavex::response::Response {
