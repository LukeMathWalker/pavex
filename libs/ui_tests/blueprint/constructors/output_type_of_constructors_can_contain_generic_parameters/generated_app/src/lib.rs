...
pub mod route_0 {
    ...
    async fn handler() -> pavex::response::Response {
        let v0 = app_ea979460::fallible_with_generic_error2();
        let v1 = match v0 {
            Ok(ok) => ok,
            Err(v1) => {
                return {
                    let v2 = app_ea979460::json();
                    let v3 = app_ea979460::doubly_generic_error_handler(&v1, &v2);
        ...
        let v2 = app_ea979460::fallible_with_generic_error();
        let v3 = match v2 {
            Ok(ok) => ok,
            Err(v3) => {
                return {
                    let v4 = app_ea979460::generic_error_handler(&v3);
                    <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                        v4,
                    )
                };
        ...
        let v4 = app_ea979460::fallible_with_generic_error();
        let v5 = match v4 {
            Ok(ok) => ok,
            Err(v5) => {
                return {
                    let v6 = app_ea979460::generic_error_handler(&v5);
                    <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                        v6,
                    )
                };
        ...
        let v6 = app_ea979460::fallible();
        let v7 = match v6 {
            Ok(ok) => ok,
            Err(v7) => {
                return {
                    let v8 = app_ea979460::error_handler(&v7);
                    <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                        v8,
                    )
                };
        ...
        let v8 = app_ea979460::json();
        let v9 = app_ea979460::json();
        let v10 = app_ea979460::json();
        let v11 = app_ea979460::handler(v8, v10, &v9, v7, v5, &v3, &v1);
