...
pub mod route_0 {
    ...
    async fn stage_2() -> pavex::response::Response {
    ...
    async fn stage_4() -> pavex::response::Response {
        let response = wrapping_4().await;
        response
    }
    async fn stage_5() -> pavex::response::Response {
    ...
    async fn wrapping_1() -> pavex::response::Response {
        let v0 = crate::route_0::Next1 {
            next: stage_2,
        };
        let v1 = pavex::middleware::Next::new(v0);
        let v2 = app::via_attribute(v1);
        let v3 = match v2 {
            Ok(ok) => ok,
            Err(v3) => {
                return {
    ...
    async fn wrapping_3() -> pavex::response::Response {
        ...
        let v3 = match v2 {
            ...
            Err(v3) => {
                return {
                    let v4 = app::CustomError::into_response_override(&v3);
                    <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                        v4,
                    )
                };
    ...
    async fn wrapping_4() -> pavex::response::Response {
        let v0 = crate::route_0::Next4 {
            next: stage_5,
        };
        let v1 = pavex::middleware::Next::new(v0);
        let v2 = app::no_attribute(v1);
        let v3 = match v2 {
            Ok(ok) => ok,
            Err(v3) => {
                return {
    ...
    impl<T> std::future::IntoFuture for Next4<T>
    where
        T: std::future::Future<Output = pavex::response::Response>,
    {
        type Output = pavex::response::Response;
...
pub mod route_1 {
    ...
    async fn stage_4<'a>(
        ...
        let response = wrapping_4(s_0).await;
        response
    }
    async fn stage_5<'a>(
        s_0: &'a pavex::router::AllowedMethods,
    ...
    async fn wrapping_3(
        ...
        let v4 = match v3 {
            ...
            Err(v4) => {
                return {
                    let v5 = app::CustomError::into_response_override(&v4);
                    <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                        v5,
                    )
                };
    ...
    async fn wrapping_4(
        ...
        let v1 = crate::route_1::Next4 {
            s_0: v0,
            next: stage_5,
        };
        let v2 = pavex::middleware::Next::new(v1);
        let v3 = app::no_attribute(v2);
        let v4 = match v3 {
            Ok(ok) => ok,
            Err(v4) => {
                return {
    ...
    impl<'a, T> std::future::IntoFuture for Next4<'a, T>
    where
        T: std::future::Future<Output = pavex::response::Response>,
    {
        type Output = pavex::response::Response;
