...
pub struct ApplicationState {
    s0: app_e501823b::HttpClient,
}
#[derive(Debug, thiserror::Error)]
pub enum ApplicationStateError {
    #[error(transparent)]
    HttpClient(app_e501823b::HttpClientError),
}
pub async fn build_application_state(
    v0: app_e501823b::Config,
) -> Result<crate::ApplicationState, crate::ApplicationStateError> {
    let v1 = app_e501823b::http_client(v0);
    let v2 = match v1 {
        Ok(ok) => ok,
        Err(v2) => {
            return {
...
pub mod route_0 {
    ...
    async fn wrapping_1(
        ...
        let v3 = pavex::middleware::Next::new(v2);
        let v4 = app_e501823b::fallible_wrapping_middleware(v3);
        let v5 = match v4 {
            Ok(ok) => ok,
            Err(v5) => {
                return {
                    let v6 = app_e501823b::handle_middleware_error(&v5);
    ...
    > {
        ...
        let v1 = match v0 {
            ...
            Err(v1) => {
                return {
                    let v2 = app_e501823b::pre_error(&v1);
    ...
    async fn handler(
        ...
        let v2 = match app_e501823b::logger() {
            Ok(ok) => ok,
            Err(v2) => {
                return {
                    let v3 = app_e501823b::handle_logger_error(&v2);
                    <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                        v3,
                    )
                };
        ...
        let v3 = app_e501823b::extract_path(v0);
        let v4 = match v3 {
            Ok(ok) => ok,
            Err(v4) => {
                return {
                    let v5 = match app_e501823b::logger() {
                        Ok(ok) => ok,
                        Err(v5) => {
                            return {
                                let v6 = app_e501823b::handle_logger_error(&v5);
                                <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                                    v6,
                                )
                            };
                    ...
                    let v6 = app_e501823b::handle_extract_path_error(&v4, v5);
                    <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                        v6,
                    )
                };
        ...
        let v5 = app_e501823b::request_handler(v4, v2, v1);
        let v6 = match v5 {
            Ok(ok) => ok,
            Err(v6) => {
                return {
                    let v7 = app_e501823b::handle_handler_error(&v6);
                    <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                        v7,
                    )
                };
    ...
    async fn post_processing_0(
        ...
        let v1 = app_e501823b::fallible_post(v0);
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
                    let v3 = app_e501823b::post_error(&v2);
                    <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                        v3,
                    )
                };
        ...
        T: std::future::Future<Output = pavex::response::Response>,
    {
        s_0: pavex::request::RequestHead,
        s_1: &'a app_e501823b::HttpClient,
        next: fn(pavex::request::RequestHead, &'a app_e501823b::HttpClient) -> T,
    }
...
pub mod route_1 {
    ...
    async fn wrapping_1(
        ...
        let v2 = pavex::middleware::Next::new(v1);
        let v3 = app_e501823b::fallible_wrapping_middleware(v2);
        let v4 = match v3 {
            Ok(ok) => ok,
            Err(v4) => {
                return {
                    let v5 = app_e501823b::handle_middleware_error(&v4);
                    <pavex::response::Response as pavex::response::IntoResponse>::into_response(
                        v5,
                    )
                };
