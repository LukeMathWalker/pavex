...
pub async fn build_application_state(v0: app_776ff188::A) -> crate::ApplicationState {
...
pub mod route_0 {
    pub async fn entrypoint<'a>(s_0: &'a app_776ff188::B) -> pavex::response::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1<'a>(s_0: &'a app_776ff188::B) -> pavex::response::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: &app_776ff188::B) -> pavex::response::Response {
    ...
    async fn handler(v0: &app_776ff188::B) -> pavex::response::Response {
