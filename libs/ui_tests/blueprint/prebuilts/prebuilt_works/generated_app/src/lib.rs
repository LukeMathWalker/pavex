...
pub struct ApplicationState {
    s0: app_e4a8214b::A,
    s1: app_e4a8214b::C<'static>,
    s2: alloc::vec::Vec<alloc::string::String>,
    s3: app_e4a8214b::B<alloc::string::String>,
}
pub async fn build_application_state(
    v0: app_e4a8214b::A,
    v1: app_e4a8214b::C<'static>,
    v2: alloc::vec::Vec<alloc::string::String>,
    v3: app_e4a8214b::B<alloc::string::String>,
...
pub mod route_0 {
    pub async fn entrypoint<'a, 'b>(
        s_0: &'a app_e4a8214b::A,
        s_1: app_e4a8214b::C<'static>,
        s_2: alloc::vec::Vec<alloc::string::String>,
        s_3: &'b app_e4a8214b::B<alloc::string::String>,
    ) -> pavex::response::Response {
        let response = wrapping_0(s_0, s_1, s_2, s_3).await;
        response
    }
    async fn stage_1<'a, 'b>(
        s_0: &'a app_e4a8214b::B<alloc::string::String>,
        s_1: app_e4a8214b::C<'static>,
        s_2: alloc::vec::Vec<alloc::string::String>,
        s_3: &'b app_e4a8214b::A,
    ) -> pavex::response::Response {
    ...
    async fn handler(
        v0: &app_e4a8214b::B<alloc::string::String>,
        v1: app_e4a8214b::C<'static>,
        v2: alloc::vec::Vec<alloc::string::String>,
        v3: &app_e4a8214b::A,
    ) -> pavex::response::Response {
        let v4 = app_e4a8214b::handler(v3, v0, v1, v2);
        ...
        T: std::future::Future<Output = pavex::response::Response>,
    {
        ...
        s_3: &'b app_e4a8214b::A,
        next: fn(
            &'a app_e4a8214b::B<alloc::string::String>,
            app_e4a8214b::C<'static>,
