...
pub mod route_0 {
    ...
    async fn handler() -> pavex::response::Response {
        let v0 = app_0ca8edfa::a();
        let v1 = app_0ca8edfa::b(&v0);
        let v2 = match v1 {
            Ok(ok) => ok,
            Err(v2) => {
                return {
                    let v3 = app_0ca8edfa::error_handler(&v0, &v2);
                    let v4 = pavex::Error::new(v2);
                    {
                        app_0ca8edfa::error_observer(v0, &v4);
                        app_0ca8edfa::error_observer2(&v4)
                    };
        ...
        let v3 = app_0ca8edfa::handler(&v2);
