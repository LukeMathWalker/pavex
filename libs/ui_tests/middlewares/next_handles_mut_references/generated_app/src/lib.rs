...
pub mod route_0 {
    ...
    async fn stage_1(mut s_0: app_db1cbdff::A) -> pavex::response::Response {
        let response = wrapping_1(&mut s_0).await;
        let response = post_processing_0(s_0, response).await;
        response
    }
    async fn stage_2<'a>(s_0: &'a mut app_db1cbdff::A) -> pavex::response::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0() -> pavex::response::Response {
        let v0 = app_db1cbdff::a();
    ...
    async fn wrapping_1(v0: &mut app_db1cbdff::A) -> pavex::response::Response {
        let v1 = crate::route_0::Next1 {
            s_0: v0,
            next: stage_2,
        };
        let v2 = pavex::middleware::Next::new(v1);
        let v3 = app_db1cbdff::mw(v2);
        <pavex::response::Response as pavex::response::IntoResponse>::into_response(v3)
    }
    async fn handler(v0: &mut app_db1cbdff::A) -> pavex::response::Response {
        let v1 = app_db1cbdff::handler(v0);
    ...
    async fn post_processing_0(
        ...
        let v2 = app_db1cbdff::post(v0, v1);
    ...
    where
        T: std::future::Future<Output = pavex::response::Response>,
    {
        s_0: &'a mut app_db1cbdff::A,
        next: fn(&'a mut app_db1cbdff::A) -> T,
    }
...
pub mod route_1 {
    ...
    async fn post_processing_0(
        ...
        let v1 = app_db1cbdff::a();
        let v2 = app_db1cbdff::post(v1, v0);
        <pavex::response::Response as pavex::response::IntoResponse>::into_response(v2)
    }
    struct Next0<'a, T>
    where
