...
pub async fn build_application_state(v0: app_e628417e::Spy) -> crate::ApplicationState {
...
pub mod route_1 {
    ...
    async fn stage_1<'a>(s_0: &'a app_e628417e::Spy) -> pavex::response::Response {
        let response = wrapping_1(s_0).await;
        response
    }
    async fn stage_2<'a>(s_0: &'a app_e628417e::Spy) -> pavex::response::Response {
    ...
    async fn stage_3<'a>(s_0: &'a app_e628417e::Spy) -> pavex::response::Response {
    ...
    async fn wrapping_0(v0: &app_e628417e::Spy) -> pavex::response::Response {
    ...
    async fn wrapping_1(v0: &app_e628417e::Spy) -> pavex::response::Response {
    ...
    async fn wrapping_2(v0: &app_e628417e::Spy) -> pavex::response::Response {
    ...
    async fn handler(v0: &app_e628417e::Spy) -> pavex::response::Response {
        let v1 = app_e628417e::handler(v0).await;
        <pavex::response::Response as pavex::response::IntoResponse>::into_response(v1)
    }
