    ...
    pub async fn route(
        ...
        let Ok(matched_route) = self.router.at(&request_head.target.path()) else {
            let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter(
                ...
                .into();
            return route_1::entrypoint(state.singleton.clone(), &allowed_methods).await;
        };
        match matched_route.value {
            0u32 => {
                match &request_head.method {
                    &pavex::http::Method::GET => {
                        route_0::entrypoint(state.singleton.clone()).await
                    }
                    _ => {
                        let allowed_methods: pavex::router::AllowedMethods = pavex::router::MethodAllowList::from_iter([
                                pavex::http::Method::GET,
                            ...
                            .into();
                        route_1::entrypoint(state.singleton.clone(), &allowed_methods)
                            .await
                    }
                }
            }
...
pub mod route_0 {
    pub async fn entrypoint(s_0: app::Singleton) -> pavex::response::Response {
