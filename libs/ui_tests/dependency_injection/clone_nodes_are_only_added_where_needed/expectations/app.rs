...
pub mod route_1 {
    pub async fn entrypoint(s_0: app::Singleton) -> pavex::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: app::Singleton) -> pavex::Response {
        let response = wrapping_1(s_0).await;
        response
    }
    async fn stage_2(s_0: app::Singleton) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    ...
    async fn handler(v0: app::Singleton) -> pavex::Response {
