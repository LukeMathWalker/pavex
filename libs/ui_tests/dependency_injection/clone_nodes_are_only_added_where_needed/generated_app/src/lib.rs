...
pub mod route_0 {
    pub async fn entrypoint(s_0: app_366b29bf::Singleton) -> pavex::response::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: app_366b29bf::Singleton) -> pavex::response::Response {
        let response = wrapping_1(s_0).await;
        response
    }
    async fn stage_2(s_0: app_366b29bf::Singleton) -> pavex::response::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: app_366b29bf::Singleton) -> pavex::response::Response {
    ...
    async fn wrapping_1(v0: app_366b29bf::Singleton) -> pavex::response::Response {
