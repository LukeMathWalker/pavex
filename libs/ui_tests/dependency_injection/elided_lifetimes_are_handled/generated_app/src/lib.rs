...
pub mod route_0 {
    pub async fn entrypoint<'a>(s_0: &'a app_ddc3d7f1::A) -> pavex::response::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1<'a>(s_0: &'a app_ddc3d7f1::A) -> pavex::response::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: &app_ddc3d7f1::A) -> pavex::response::Response {
    ...
    async fn handler(v0: &app_ddc3d7f1::A) -> pavex::response::Response {
        let v2 = {
            let v1 = app_ddc3d7f1::Generic::new(v0);
            app_ddc3d7f1::handler::<app_ddc3d7f1::Generic>(v1)
        };
