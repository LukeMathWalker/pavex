...
pub mod route_1 {
    ...
    async fn stage_2(s_0: app::Scoped) -> pavex::Response {
        let response = wrapping_2(s_0).await;
        response
    }
    async fn stage_3(s_0: app::Scoped) -> pavex::Response {
        let response = handler(s_0).await;
        response
    }
    ...
    async fn wrapping_2(v0: app::Scoped) -> pavex::Response {
        let v1 = <app::Scoped as core::clone::Clone>::clone(&v0);
    ...
    async fn handler(v0: app::Scoped) -> pavex::Response {
