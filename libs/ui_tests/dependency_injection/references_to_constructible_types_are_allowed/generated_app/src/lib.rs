...
pub mod route_0 {
    ...
    async fn stage_1<'a>(s_0: &'a app_c266691d::Singleton) -> pavex::response::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: &app_c266691d::Singleton) -> pavex::response::Response {
    ...
    async fn handler(v0: &app_c266691d::Singleton) -> pavex::response::Response {
        let v1 = app_c266691d::request_scoped();
        let v3 = {
            let v2 = app_c266691d::transient();
            app_c266691d::stream_file(v0, &v1, &v2)
        };
        <pavex::response::Response as pavex::response::IntoResponse>::into_response(v3)
    }
    struct Next0<'a, T>
