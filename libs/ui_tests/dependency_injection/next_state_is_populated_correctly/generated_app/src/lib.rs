...
pub mod route_0 {
    ...
    async fn stage_1<'a>(s_0: &'a app_8b5f0867::Singleton) -> pavex::response::Response {
    ...
    async fn wrapping_0(v0: &app_8b5f0867::Singleton) -> pavex::response::Response {
    ...
    async fn wrapping_1(v0: &app_8b5f0867::Singleton) -> pavex::response::Response {
