...
pub mod route_0 {
    ...
    async fn stage_1<'a>(s_0: &'a app_d1b695a6::Streamer) -> pavex::response::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: &app_d1b695a6::Streamer) -> pavex::response::Response {
    ...
    async fn handler(v0: &app_d1b695a6::Streamer) -> pavex::response::Response {
        let v1 = app_d1b695a6::stream_file(v0);
