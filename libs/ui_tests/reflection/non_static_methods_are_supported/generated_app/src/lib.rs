...
pub mod route_0 {
    ...
    async fn wrapping_0(v0: &app_40e90d31::LoggerFactory) -> pavex::response::Response {
    ...
    async fn handler(v0: &app_40e90d31::LoggerFactory) -> pavex::response::Response {
        let v1 = app_40e90d31::Streamer::new();
        let v3 = {
            let v2 = app_40e90d31::LoggerFactory::logger(v0);
            app_40e90d31::Streamer::stream_file(&v1, v2)
        };
        <pavex::response::Response as pavex::response::IntoResponse>::into_response(v3)
    }
    struct Next0<'a, T>
