...
pub mod route_0 {
    ...
    async fn handler() -> pavex::response::Response {
        let v0 = <app_a7fd6a2c::A as app_a7fd6a2c::MyTrait>::a_method_that_returns_self();
        let v1 = <app_a7fd6a2c::A as app_a7fd6a2c::MyTrait>::a_method_that_borrows_self(
            &v0,
        );
        let v2 = <app_a7fd6a2c::B as app_a7fd6a2c::AnotherTrait>::a_method_that_consumes_self(
            v1,
        );
        let v3 = <app_a7fd6a2c::C as app_a7fd6a2c::GenericTrait<
            std::string::String,
        >>::a_method(&v2);
        let v4 = <app_a7fd6a2c::A as app_a7fd6a2c::MyTrait>::a_method_with_a_generic::<
            std::string::String,
        >(&v0);
        let v5 = app_a7fd6a2c::handler(v0, v2, v4, v3);
