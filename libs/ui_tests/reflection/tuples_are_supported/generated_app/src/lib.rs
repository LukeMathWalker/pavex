...
pub async fn build_application_state() -> crate::ApplicationState {
    let v0 = app_1bd0738c::constructor_with_output_tuple();
...
pub mod route_0 {
    pub async fn entrypoint(s_0: (usize, isize)) -> pavex::response::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: (usize, isize)) -> pavex::response::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: (usize, isize)) -> pavex::response::Response {
    ...
    async fn handler(v0: (usize, isize)) -> pavex::response::Response {
        let v1 = app_1bd0738c::handler_with_input_tuple(v0);
