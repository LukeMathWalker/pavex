...
pub mod route_0 {
    pub async fn entrypoint(s_0: app_e1c9a48c::A) -> pavex::response::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: app_e1c9a48c::A) -> pavex::response::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: app_e1c9a48c::A) -> pavex::response::Response {
    ...
    async fn handler(v0: app_e1c9a48c::A) -> pavex::response::Response {
        let v1 = <app_e1c9a48c::A as core::clone::Clone>::clone(&v0);
        let v2 = app_e1c9a48c::b(v1);
        let v3 = app_e1c9a48c::c(v0);
        let v4 = app_e1c9a48c::handler(v2, v3);
