...
pub mod route_0 {
    ...
    async fn handler() -> pavex::response::Response {
        let v0 = app_9b6ffdef::a();
        let v1 = <app_9b6ffdef::A as core::clone::Clone>::clone(&v0);
        let v2 = app_9b6ffdef::b(v1);
        let v3 = app_9b6ffdef::c(v0);
        let v4 = app_9b6ffdef::handler(v2, v3);
