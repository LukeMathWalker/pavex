...
pub mod route_0 {
    pub async fn entrypoint(s_0: app_d2e8db7a::A) -> pavex::response::Response {
        let response = wrapping_0(s_0).await;
        response
    }
    async fn stage_1(s_0: app_d2e8db7a::A) -> pavex::response::Response {
        let response = handler(s_0).await;
        response
    }
    async fn wrapping_0(v0: app_d2e8db7a::A) -> pavex::response::Response {
    ...
    async fn handler(v0: app_d2e8db7a::A) -> pavex::response::Response {
        let v1 = <app_d2e8db7a::A as core::clone::Clone>::clone(&v0);
        let v2 = app_d2e8db7a::b(v1);
        let v3 = app_d2e8db7a::handler(&v0, v2);
        <pavex::response::Response as pavex::response::IntoResponse>::into_response(v3)
    }
    struct Next0<T>
    where
