...
pub mod route_0 {
    ...
    async fn handler(
        ...
        let v2 = app_f10df8fa::extract_path(v1).await;
        let v3 = match v2 {
            Ok(ok) => ok,
            Err(v3) => {
                return {
                    let v5 = {
                        ...
                        app_f10df8fa::handle_extract_path_error(&v3, v4)
                    };
        ...
        let v5 = {
            let v4 = app_f10df8fa::logger();
            app_f10df8fa::stream_file(v3, v4, v0)
        };
        ...
        T: std::future::Future<Output = pavex::response::Response>,
    {
        s_0: app_f10df8fa::HttpClient,
        s_1: pavex::request::RequestHead,
        next: fn(app_f10df8fa::HttpClient, pavex::request::RequestHead) -> T,
    }
