...
"#;
    ...
    insta::assert_snapshot!(format!("{:#}", err), @"Failed to parse the root certificate at index 0 in your list of `additional_roots`: Failed to decode base64-encoded DER certificate: Invalid symbol 32, offset 4.");
}
