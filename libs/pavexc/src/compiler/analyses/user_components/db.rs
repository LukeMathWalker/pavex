...
use crate::compiler::analyses::user_components::annotations::process_imported_modules;
...
impl UserComponentDb {
    ...
    pub(crate) fn build(
        ...
        process_imported_modules(&imported_modules, &mut aux, krate_collection, diagnostics);
        exit_on_errors!(diagnostics);
